...
void TestCarveMode0() {
  ...
  if (inimg.height() == 6 && inimg.width() == 5) {
    ...
    PNG imggg;
    imggg.readFromFile("output-images/soln-5x6-1-1.png");
    ...
    cout << "Rendering carved image using rendermode 0... ";
    PNG outputimg6 = list5x6.Render(true, 0);
    cout << "done." << endl;

    cout << "Writing output PNG to 5x6-1-0-c2.png... ";
    outputimg6.writeToFile("output-images/5x6-1-0-c2.png");
    cout << "done." << endl;

    cout << "Rendering carved image using rendermode 0... ";
    PNG outputimg7 = list5x6.Render(true, 1);
    cout << "done." << endl;

    cout << "Writing output PNG to 5x6-1-1-c2.png... ";
    outputimg7.writeToFile("output-images/5x6-1-1-c2.png");
    cout << "done." << endl;
