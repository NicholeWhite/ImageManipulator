...
TEST_CASE("colorPicker::basic negative2","[weight=1][part=colorPicker]"){
    ...
    PNG result = testColorPicker(negativePicker);
    result.writeToFile("images/leaf_negative.png");
    PNG expected; expected.readFromFile("soln_images/leaf_neg.png");
    REQUIRE(result == expected);
}
